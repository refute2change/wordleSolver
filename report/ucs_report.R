#read json
library(jsonlite)
data <- fromJSON("C:/Users/tvu50/Downloads/report/ucs_experiment_report.json")
str(data)
...
ve_bieu_do("nodes_processed", y_min= 3700, y_max = 4050)

# (Xem chán rồi thì bấm dòng dưới- này Gemini nó nói nha)
ve_bieu_do("time", y_min = 40, y_max = 82)
...
ve_bieu_do("avg_time_per_game", y_min = 0.003, y_max=0.007)
